...
# -----------------------------------------------------------------------------
# Step 2: Analysis
# Reads: temp/eminent_domain.rds, code/DGP.R, code/helper.R
# Writes: output/tables/table2.tex, output/tables/table3.tex
# -----------------------------------------------------------------------------
output/tables/table2.tex output/tables/table3.tex: \
...
# Reads: paper/paper.tex, paper/references.bib,
#        output/tables/table2.tex, output/tables/table3.tex
...
clean:
	...
	rm -f output/tables/table2.tex output/tables/table3.tex
